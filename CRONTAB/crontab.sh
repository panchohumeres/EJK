...
07 * * * * papermill /home/jovyan/ /ETL/dashboards_gob/CKAN_to_elastic_encrypted.ipynb /home/jovyan/ /CRONTAB/logs/CKAN_to_elastic_encrypted_`date +\%Y\%m\%d\%H\%M\%S`.ipynb